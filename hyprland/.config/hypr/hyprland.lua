...
hl.env("XCURSOR_THEME", "Cartoonish-Bold")
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(11aaddcc)", "rgba(00ff99ee)"}, angle = 45 },
...
-- Default springs
hl.curve("easy",           { type = "spring", mass = 2.500, stiffness = 71.2633, dampening = 15.8273644 })
hl.curve( "rubber",        { type = "spring", mass = 1.000, stiffness = 70.0000, dampening = 10.0000000 } )
hl.curve("easy2",          { type = "spring", mass = 1.0900, stiffness = 170.2633, dampening = 15.8273644 })

hl.animation({ leaf = "global"         , enabled = true,  speed = 10    , bezier = "default" })
hl.animation({ leaf = "border"         , enabled = true,  speed = 5.39  , bezier = "easeOutQuint" })
hl.animation({ leaf = "windows"        , enabled = true,  speed = 4.79  , bezier = "overshoot" })
hl.animation({ leaf = "windowsIn"      , enabled = true,  speed = 4.10  , spring = "easy2",         style = "popin 50%" })
hl.animation({ leaf = "windowsOut"     , enabled = true,  speed = 4.49  , spring = "easy2",       style = "popin 50%" })
hl.animation({ leaf = "fadeIn"         , enabled = true,  speed = 1.73  , bezier = "almostLinear" })
hl.animation({ leaf = "fadeOut"        , enabled = true,  speed = 1.46  , bezier = "almostLinear" })
hl.animation({ leaf = "fade"           , enabled = true,  speed = 3.03  , bezier = "quick" })
hl.animation({ leaf = "layers"         , enabled = true,  speed = 3.81  , bezier = "easeOutQuint", style = "slidefade 50%" })
hl.animation({ leaf = "layersIn"       , enabled = true,  speed = 4.00  , bezier = "easeOutQuint", style = "slidefade 50%" })
hl.animation({ leaf = "layersOut"      , enabled = true,  speed = 1.50  , bezier = "linear",       style = "slidefade 50%" })
hl.animation({ leaf = "fadeLayersIn"   , enabled = true,  speed = 1.79  , bezier = "almostLinear" })
hl.animation({ leaf = "fadeLayersOut"  , enabled = true,  speed = 1.39  , bezier = "almostLinear" })
hl.animation({ leaf = "workspaces"     , enabled = true,  speed = 5.00  , spring = "easy2", style = "slidefade 100%" })
hl.animation({ leaf = "workspacesIn"   , enabled = true,  speed = 5.00  , spring = "easy2", style = "slidefade 100%" })
hl.animation({ leaf = "workspacesOut"  , enabled = true,  speed = 5.00  , spring = "easy2", style = "slidefade 100%" })
hl.animation({ leaf = "zoomFactor"     , enabled = true,  speed = 7.00  , bezier = "quick" }) --Thala for reason
...
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd(browser), { locked = true })
    ...
    hl.bind(" Print", hl.dsp.exec_cmd("hyprshot -m region -o ~/Pictures/Screenshots"), { locked = true })
hl.bind("XF86PowerOff",  hl.dsp.exec_cmd("wlogout"))
hl.bind("switch:off:Lid Switch",  hl.dsp.exec_cmd("hyprlock"))
hl.bind(mainMod .. " + CONTROL + W", 
   --Wallpaper
